...
export default function Carousel() {
  ...
  //   // Ensure ipcRenderer is available in window object
  //   // if (window.ipcRenderer) {
  //   //   // Call ipcRenderer.send to trigger the 'button-clicked' event
  //   //   window.ipcRenderer.send('button-clicked');
  //   // } else {
  //   //   console.error('ipcRenderer is not available in window object yusysususus ');
  //   // }
  //   window.api.navigateToNewPage();
  ...
  return (
    ...
    >
      ...
      {/* D) Hero Content */}
      <div className="relative text-left z-20 w-full px-4 py-8">
